...
// --- Firebase and Key Generation Logic (Only for getkey.html) ---
...
// --- Contact Form Logic (Only for contact.html) ---
if (window.location.pathname.includes('contact.html')) {
  // EmailJS Script (already included in contact.html)
  document.getElementById("supportForm")?.addEventListener("submit", function(e) {
    e.preventDefault();
    emailjs.sendForm(
      "service_39jqmhf", // Your EmailJS service ID
      "template_y3xutk8", // Your EmailJS template ID
      this
    )
    .then(
      function(response) {
